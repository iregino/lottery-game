...
label6 = Label(window, relief = "groove", width = 2, bg = "yellow")
getBtn = Button(window, text = " Get My Lucky Numbers ")
resBtn = Button(window, text = " Reset ")

# Geometry
imgLbl.grid(row = 1, column = 1, rowspan =2, padx = 10, pady = 10)
...
def pick():
    nums = sample(range(1, 71), 5)
    megaball = sample(range(1,26), 1)
    print("Sample 1-70:", nums, "Megaball 1-25:", megaball)
    ...
    label6.configure(text=megaball[0])
